...
@section('main')
    <div class="container" id="regApp">
        ...
        <div class="row justify-content-center">
            <form class="col-5" action="{{route('register')}}" method="post">
                @csrf
                @method('post')
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary col-12" style="background-color: #043F7E; color: #D2D2FF; border: none">Регистрация</button>
            </form>
        </div>
    </div>
